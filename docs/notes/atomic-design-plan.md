...
- [目的](#目的)
- [対象外](#対象外)
- [page.tsx の役割](#pagetsx-の役割)
- [ディレクトリ構成（最終形）](#ディレクトリ構成最終形)
- [カスタムフック責務境界](#カスタムフック責務境界)
  - [依存関係](#依存関係)
- [Phase 1: Organisms（画面単位の分割）](#phase-1-organisms画面単位の分割)
  - [概要](#概要)
  - [作業内容](#作業内容)
  - [完了基準](#完了基準)
  - [管理者フロー手動確認チェックリスト](#管理者フロー手動確認チェックリスト)
- [Phase 2: Molecules（共通UIパーツの切り出し）](#phase-2-molecules共通uiパーツの切り出し)
  - [概要](#概要-1)
  - [作業内容](#作業内容-1)
  - [完了基準](#完了基準-1)
- [Phase 3: カスタムフック（ロジック分離）](#phase-3-カスタムフックロジック分離)
  - [概要](#概要-2)
  - [作業内容](#作業内容-2)
  - [完了基準](#完了基準-2)
- [Phase 4: Atoms 整理（既存コンポーネントの移動）](#phase-4-atoms-整理既存コンポーネントの移動)
  - [概要](#概要-3)
  - [作業内容](#作業内容-3)
  - [完了基準](#完了基準-3)
- [実施順序](#実施順序)
