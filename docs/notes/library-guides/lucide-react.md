...
- [基本的な使い方](#基本的な使い方)
  - [主な props](#主な-props)
  - [サイズ指定の2つの方法](#サイズ指定の2つの方法)
- [本プロジェクトで使用しているアイコン一覧](#本プロジェクトで使用しているアイコン一覧)
  - [page.tsx で使用（11種類）](#pagetsx-で使用11種類)
  - [Modal.tsx で使用（2種類）](#modaltsx-で使用2種類)
- [アイコンの使い方パターン（本プロジェクトの実例）](#アイコンの使い方パターン本プロジェクトの実例)
  - [パターン1: ボタン内のアイコン](#パターン1-ボタン内のアイコン)
  - [パターン2: アイコンのみのボタン（アクセシビリティ対応）](#パターン2-アイコンのみのボタンアクセシビリティ対応)
  - [パターン3: 装飾的なアイコン（ブランド / 背景）](#パターン3-装飾的なアイコンブランド--背景)
  - [パターン4: 入力欄の先頭アイコン](#パターン4-入力欄の先頭アイコン)
  - [パターン5: variant に応じたアイコンの切り替え](#パターン5-variant-に応じたアイコンの切り替え)
- [なぜ lucide-react を選んでいるか](#なぜ-lucide-react-を選んでいるか)
- [注意点](#注意点)
